...
export const grade7Storylets: readonly Storylet[] = [
  {
    ...
    text: 'El aula huele a cuaderno nuevo y todavía nadie sabe los nombres de todos. Lo primero que hay que aprender es cómo llegar a horario.',
    challengePool: [],
  ...
  },
  {
    ...
    requires: { kind: 'never' },
    tags: ['repaso'],
    eyebrow: 'Antes de cerrar 7.º',
    title: 'Quedó algo dando vueltas',
    text: 'La profe te para en el pasillo: «Esa cuenta del colectivo quedó por la mitad. Sentate cinco minutos y la sacamos, así cerrás bien el año.»',
    challengePool: [],
    effects: [],
    followUps: [],
  },
