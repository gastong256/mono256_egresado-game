...
/**
 * Juega la carrera con el motor real, desde el descriptor que emitió el servidor.
 *
 * `quality` decide qué tan bien se responde cada situación, así que la misma
 * función produce una partida fuerte y una floja sin saber de antemano qué
 * Template va a tocar.
 */
function playCareer(
  descriptor: RunDescriptor,
