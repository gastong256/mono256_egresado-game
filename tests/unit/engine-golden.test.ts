 ...
 *
 * Los valores actuales corresponden al score competitivo (`ENGINE_VERSION`
 * 5.1.0, contenido de desarrollo `0.6.0-dev`). El hash del estado se movió
 ...
 *
 * Estos golden fijan el score **por evento** de la capa de carrera, que esta
 * etapa no tocó. El score competitivo tiene sus propios golden en
 * `score-golden.test.ts` y no reinterpreta a éstos. Otra vez: el recorrido, el score, el perfil y
...
const GOLDEN_RUNS: readonly Golden[] = [
  {
    ...
    hash: '59c23661e9e3995fa710afd1a7d73339db15e49e1f74dd946b1219f6bd3ab343',
  },
  {
    seed: 'golden-beta',
    score: 6427,
    ...
    hash: '1ba8488e8856b7515ae71bd2860feb9a18e6594208dd44ddbbb0d383b584eca0',
  },
]
