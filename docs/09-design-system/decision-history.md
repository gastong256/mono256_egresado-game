...
**Aura aparece recién cuando hay un momento público, y ése es el acto del 25 de Mayo.** Durante v0.2 la dimensión estaba construida y probada pero nunca se veía en una partida, porque ninguno de los cinco eventos autorados era socialmente memorable: la tira no la mostraba porque el modelo decía que no había nada que mostrar. La respuesta no fue aflojar la regla sino autorar el evento que la justifica. El acto es el único del arco que pasa adelante de toda la escuela, y por eso puede mover Aura sin que sea un premio por hacer bien una cuenta. La regla de fondo no cambió: una dimensión sin establecer no se dibuja, y `null` sigue sin ser 0.
