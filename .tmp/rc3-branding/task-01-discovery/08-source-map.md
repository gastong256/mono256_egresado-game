# Mapa de fuentes y trazabilidad
...
| Topic | Canonical source | Secondary source / evidencia existente | Relevant symbol / hallazgo | Status |
|---|---|---|---|---|
...
## Documentación consultada: 39 archivos de docs
...
| docs/03-architecture/adr/ADR-003-deterministic-seeded-engine.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-004-server-authoritative-scoring.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-007-content-as-data.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-015-design-system-tokens.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-017-paper-visual-identity.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-019-scenario-family-template-variant.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-020-variant-generation-and-approved-catalog.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-022-difficulty-model-and-run-composer.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-023-competitive-score-policy.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-024-progression-recovery-and-graduation.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-025-full-career-contract-evolution.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-026-participant-identity-and-minor-privacy.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-027-release-freeze-and-v1-governance.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
| docs/03-architecture/adr/ADR-028-zero-cost-fair-deployment.md | Decisión aceptada y consecuencias aplicables; ADR largos leídos por secciones de decisión |
