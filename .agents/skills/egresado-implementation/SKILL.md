...
6. Planifica e implementa el cambio coherente mas pequeno respetando las fronteras ejecutables:
   - `src/game/**` es TypeScript puro, determinista y sin DOM, red, reloj global, RNG global, React, Next ni Supabase;
...
7. Agrega tests proporcionales: unit/property para core y contenido; integration para API/DB; componentes para UI aislada; Playwright/accesibilidad para flujos visibles.
